...
class WappalyzerParserParser(object):
    """
    Get Wappalyzer results to defectdojo
    """

    def get_scan_types(self):
        return ["wappalyzer Scan"]

    def get_label_for_scan_types(self, scan_type):
        return "wappalyzer Scan"
 
    def get_description_for_scan_types(self, scan_type):
        return "wappalyzer report file can be imported in CSV format."
